...
- [<a name="starting"></a>Starting the schema](#starting-the-schema)
- [<a name="properties"></a>Defining the properties](#defining-the-properties)
- [<a name="properties-deeper"></a>Going deeper with properties](#going-deeper-with-properties)
- [<a name="nesting"></a>Nesting data structures](#nesting-data-structures)
- [<a name="references"></a>References outside the schema](#references-outside-the-schema)
- [<a name="data"></a>Taking a look at data for our defined JSON Schema](#taking-a-look-at-data-for-our-defined-json-schema)
