---
# Context definition for openDS json schemas
---

## Introduction
This page provides the @context definition for all openDS JSON-LD schemas.

This page should be read in conjunction with the page(s) dealing with the [structure of openDS json schemas](basic-structure.md)


>>>>>>. look also at FAIR Datapoints - same thing as schema.org. Need to think about relation of DS object type definition to these things in a bit more depth. Mustn't encode everything in the DSschema necessarily!!!
...
```json
{
     "@id": "https://know.dissco.eu/opends/1.0/context",
     "name": [
          "openDS JSON-LD Context"
     ],
     "version": "1.0.0",
     "url": {
          "@id": "https://know.dissco.eu/opends/1.0"
     },
     "schemaVersion": {
          "@id": "http://schema.org/version/11.01/"
     },
     "isBasedOn": [
          {
